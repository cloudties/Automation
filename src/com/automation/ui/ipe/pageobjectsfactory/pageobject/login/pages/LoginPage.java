package com.automation.ui.ipe.pageobjectsfactory.pageobject.login.pages;
...
import com.automation.ui.ipe.pageobjectsfactory.pageobject.login.xpathconstants.LoginCONSTANTS;
...
import com.automation.ui.base.common.prpreaders.AssertDataReader;
public class LoginPage extends IPEBasePageObject {
    ...
    public LoginPage enterUser(String userName) {
        try {
            ...
            logger.debug("Exiting enterUser login" + AssertDataReader.assertreader.getValue("OPCUA_LOGIN_LOGINMSG"));
             Assertion.fail(AssertDataReader.assertreader.getValue("OPCUA_LOGIN_LOGINMSG"));
    ...
    public LoginPage enterPassword(String upassword) {
        try {
            ...
            Assertion.fail(AssertDataReader.assertreader.getValue("OPCUA_PASSWORD"));
