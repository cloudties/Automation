...
public class EmailUtils {
    ...
    private static final String EMAIL_LINK_PATTERN = ".*<B[^>]*href=\"(?<url>[^\"]+?)\"[^>]+>%s</B>.*";
    ...
    private static String getLinkWith(String mailContent, String linkValue) {
      ...
      and replace "=3D" sequence with B single "=" character
    ...
    */
    ...
    /**
     * Method generates B new "fake" email, by adding number of "+" characters before "@" symbol,
