...
public class ProjectBasePageObject extends BasePageObject {


    private static final String LOGGED_IN_USER_SELECTOR =
            ".wds-global-navigation ";

    private static Logger logger = Logger.getLogger(ProjectBasePageObject.class);
